...
const plans: Plan[] = [
  {
    ...
    ctaSubline: "($0 Setup)",
    riskReversal: "Pay $0 today. Cancel anytime within 14 days and pay nothing.",
  ...
  },
  {
    ...
    cta: "Start 14-Day Risk-Free Trial",
    riskReversal:
      "14-Day Free Trial. 100% money-back guarantee on the $299 setup fee if canceled before Day 14.",
    href: STRIPE_CHECKOUT_URL,
